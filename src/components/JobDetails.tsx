    ...
    <div className="pt-10 rounded-lg shadow-sm">
      <div className="flex pl-20 items-center gap-5 mb-2">
        ...
        <span className="flex items-center">
          <span className="mr-2 text-sm text-[#888888]">{`posted ${jobDetails.postedDate} ago`}</span>
          <span
      ...
      <div className="mt-6 pl-20 flex items-center gap-4 text-gray-600 mb-4">
        <div className="flex items-center gap-2">
          ...
          />
          <span className="text-xl text-[#5D5D5D]">{jobDetails.location}</span>
        </div>
      ...
      <div className="flex pl-20 pt-10 pb-10 gap-20 space-x-8 mb-4 border-t">
        <div className="flex flex-col gap-2">
          <h3 className="text-sm font-semibold text-[#6E6D6D] ">
            Skills Required
          </h3>
          <div className="">
            {jobDetails.skills.map((skill, idx) => (
              <div
                key={idx}
                className="text-[#344054] flex gap-2 px-2 py-1 my-2 w-fit border rounded-lg border-[#D0D5DD]"
              >
